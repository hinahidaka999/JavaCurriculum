...
//		　int型の変数をコンソールに出力して下さい。
		...
		int intChangedNumber = (int) number;
		System.out.println(intChangedNumber);
		String stringChangedNumber = String.valueOf(intChangedNumber);
		System.out.println(stringChangedNumber);
		intChangedNumber = Integer.parseInt(stringChangedNumber);
	}
}
